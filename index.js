// Wrapper for https://github.com/cgcai/SVY21/blob/master/Javascript/svy21.js
var SVY21 = (function(){
...
function svy21ToWgs84(x, y) {
  const {lat, lon} = converter.computeLatLon(x, y)
  return [lat, lon]
}

function wgs84ToSvy21(lat, lng) {
  const {N, E} = converter.computeSVY21(lat, lng)
  return [N, E]
}

module.exports = { svy21ToWgs84, wgs84ToSvy21 }
